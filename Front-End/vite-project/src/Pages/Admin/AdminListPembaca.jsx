...
export default function AdminListPembaca() {
  // const siswa = [
  //       {
  //           nama: "Surya",
  ...
  //       {
  //           nama: "Ahdiyat",
  //           email: "ahdiyat@gmail.com"
  //       },
  //       {
  //           nama: "Dipsy",
  //           email: "dipsy@gmail.com"
  //       },
  //       {
  //           nama: "Upin",
  ...
  //       {
  //           nama: "Super Wings",
  //           email: "superwings@gmail.com"
  //       },
  //       {
  //           nama: "Pow Patrol",
  //           email: "powpatrol@gmail.com"
  //       }
  //   ]

  const [pembaca, setPembaca] = useState({})
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75" />
      ...
      <div className='w-3/4 bg-slate-950 flex justify-center items-center overflow-auto'>
        ...
        <ShowTable pembaca={pembaca} sendData={sendData} handleDelete={handleDelete}/>
      </div>
    </div>
  )
